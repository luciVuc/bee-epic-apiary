...
describe('delete-product handler', () => {
	...
	it('handles Stripe errors with statusCode >= 500', async () => {
		mockStripe.products.del.mockRejectedValue({ statusCode: 500, message: 'Internal Server Error' });
	...
	it('handles Stripe errors with missing message when statusCode < 500', async () => {
		mockStripe.products.del.mockRejectedValue({ statusCode: 400 }); // No message
	...
	it('handles Stripe errors with undefined statusCode (defaults to 500)', async () => {
		mockStripe.products.del.mockRejectedValue({ message: 'Something failed' }); // No statusCode
