/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c745aa9206631999340d057eb72f4dc9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'RATE_LIMIT_MAX' | 'RATE_LIMIT_WINDOW' | 'STRIPE_SECRET_KEY' | 'ALLOWED_ORIGINS' | 'API_SECRET_KEY'>
	> {}
}
