...
export const SiInstagram = ({ className }: IIconProps) => (
  <svg
    className={className}
    aria-hidden="true"
    viewBox="0 0 24 24"
...
export const SiEtsy = ({ className }: IIconProps) => (
  <svg
    className={className}
    aria-hidden="true"
    viewBox="0 0 24 24"
...
export const SiTwitter = ({ className }: IIconProps) => (
  <svg
    className={className}
    aria-hidden="true"
    viewBox="0 0 24 24"
...
export const SiYouTube = ({ className }: IIconProps) => (
  <svg
    className={className}
    aria-hidden="true"
    viewBox="0 0 24 24"
